                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.form}>
                        <CustomValidation
                            ...
                            containerStyle={[{
                                borderRadius: ms(20),
                            }, isFocused == "email" ? { borderColor: Colors[theme].text, borderWidth: 1 } : {}]}
                        />
                        ...
                        <CustomValidation
                            ...
                            containerStyle={[{
                                borderRadius: ms(20),
                            }, isFocused == "password" ? { borderColor: Colors[theme].text, borderWidth: 1 } : {}]} onFocus={() => setIsFocused("password")}
                            rightIcon={
                                <Pressable
                        ...
                        >
                            <TouchableOpacity onPress={() => router.push("/forgotpassword2")}>
                                <ThemedText style={[styles.forgotPassword, { color: Colors.grayText }]}>
                        ...
                        <View style={styles.footerText}>
                            <ThemedText type="defaultSemiBold" style={styles.footerText}>{labels.dontHaveAnAccount}</ThemedText>
