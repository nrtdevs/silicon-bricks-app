import { ScrollView, Text, KeyboardAvoidingView, StyleSheet, TextInput, Image, Pressable } from "react-native";
    ...
    return (
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={"height"}>
            <ScrollView keyboardShouldPersistTaps="handled"
                ...
                <Text style={{ marginTop: 20, color: 'black', fontSize: 16, fontWeight: '400' }}>Forgot Password</Text>
                <TextInput
