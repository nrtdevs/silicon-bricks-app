...
import { CreateOrganizationDocument, DeleteOrganizationDocument, EnableOrganizationStatusDocument, GetAllDynamicPageDocument, PaginatedOrganizationDocument, PaginatedUsersDocument, UpdateOrganizationDocument } from "@/graphql/generated";
...
const organization = () => {
    ...
    const [pagesData, { error, data, loading, refetch }] = useLazyQuery(
        ...
        <CustomHeader>
            <ThemedView style={styles.contentContainer}>
                ...
                <View style={styles.organizationParentContainer}>
                    <FlatList
                        data={data?.getAllDynamicPage?.data}
