...
//                 <Text style={styles.cardDot}>: </Text>
//                 <TouchableOpacity onPress={() => showEditDialogue()}>
//                   <Feather name="edit" color="white" size={24} />
//                 </TouchableOpacity>
//                 <View style={{ width: 10 }}></View>
//                 <TouchableOpacity onPress={() => showDeleteDialogue()}>
...
//         />
//       </View>
//       <TouchableOpacity style={styles.fab} onPress={showDialogue}>
//         <Feather name="plus" color="white" size={24}></Feather>
//       </TouchableOpacity>
//       <Portal>
//         <Dialog visible={visible} onDismiss={hideDialogue}>
//           <Dialog.Title style={styles.dialogueTitle}>Add Project</Dialog.Title>
//           <Dialog.Content>
