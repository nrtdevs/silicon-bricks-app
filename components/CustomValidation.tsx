import { TouchableOpacity, Image, View, Pressable, ActivityIndicator } from "react-native";
...
const CustomValidation = (props: TextInputProps) => {
  ...
  const renderSelectedItem = (item: any, removeItem: any) => {
    return (
      ...
      >
        <ThemedText style={[styles.selectedItemText, { color: Colors[theme].text }]}>
    ...
    <Controller
      ...
      render={({
        ...
        const errStyle = {
          ...
          borderColor: error ? Colors.red : isFocused ? Colors.white : Colors.gray
        };
        return (
          <View style={[styles.container, props.wrapperStyle]}>
              ...
              >
                {inputMode !== "flat" && (
                  <View style={{ flexDirection: "row" }}>
                    ...
                    {(props.rules?.required && !props.hideStar && props.label) && (
              ...
              >
                ...
                {!props.multiSelect ? (
                  <Dropdown
                    ...
                    selectedTextStyle={[styles.selectedTextStyle, { color: Colors[theme].text, }]}
                    inputSearchStyle={[
                    ...
                    data={props.data}
                    maxHeight={300}
                    labelField={props.keyToShowData ? props.keyToShowData : "label"}
                    valueField={props.keyToCompareData ? props.keyToCompareData : "value"}
            ...
            {props?.type === "image" && (
              ...
              >
                <ThemedText style={[styles.labelStyle, { color: Colors[theme].text }]}>
                  {props.label}{" "}
