...
const ExpenseCard: React.FC<VehicleCardProps> = ({ item, onEdit, onDelete, onChangeStatus, onView, dots }) => {
  if (!item) {
    return null;
  }
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.titleContainer}>
            <ThemedText type='title' style={styles.brandText}>Vehicle : {item?.item?.vehicle?.model}</ThemedText>
            <ThemedText type='subtitle' style={styles.modelText}>Amount : {item?.item?.amount}</ThemedText>
          </View>
