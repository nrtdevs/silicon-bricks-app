...
export type CreateOrganizationMutation = { __typename?: 'Mutation', updateOrganization: { __typename?: 'Organization', status: string, name: string, id: string, description?: string | null } };
